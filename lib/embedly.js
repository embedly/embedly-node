...
module.exports = { 
  ...
  , api: function(opts) {
    ...
    this.oembed = function(args) {
      this.apicall( 
        {action: 'oembed', version: this.api_version['oembed']}
      , args
      )
    }
    this.objectify = function(args) {
      this.apicall( 
        {action: 'objectify', version: this.api_version['objectify']}
      , args
      )
    }
    this.preview = function(args) {
      this.apicall(
        {action: 'preview', version: this.api_version['preview']}
      , args
      )
    }
